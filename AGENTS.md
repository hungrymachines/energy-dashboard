...
```bash
npm test            # vitest (currently 107 frontend cases across 17 files)
...
`src/api/generated.ts` is auto-generated by [`openapi-typescript`](https://www.npmjs.com/package/openapi-typescript) from `openapi.snapshot.json`. The snapshot itself is regenerated from the sibling `hungry-machines-api/` repo's FastAPI app object (committed master-branch state, NOT live deployed state):
