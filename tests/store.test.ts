...
describe('authStore', () => {
  ...
  // v2.0+: getEntityMap / setEntityMap removed. Entity mapping moved to
  // appliance.config.entity_id (per-appliance) and users.weather_entity_id
  // (per-user). The hm_entity_map localStorage key is no longer touched.
